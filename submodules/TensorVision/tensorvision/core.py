...
def build_inference_graph(hypes, modules, image):
    ...
    with tf.name_scope("Validation"):
        ...
        # logits = {}
        #
        # logits1 = modules['arch'].inference(hypes, image, train=False)
        # if 'fcn_logits' in logits1:
        #     logits['fcn_logits'] = tf.image.resize_bilinear(logits1['fcn_logits'], size=[384, 1248], align_corners=True)
